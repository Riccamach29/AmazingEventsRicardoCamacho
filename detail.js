    ...
    if (eventoId) {
        ...
        if (eventoDetails) {
            ...
            <div class="col-md-6 text-center">
                <img src="${eventoDetails.image}" alt="${eventoDetails.name}" class="img-fluid">
            </div>
            <div class="col-md-6">
                <ul class="list-group">
                    <li class="list-group-item"><strong>Date:</strong> ${eventoDetails.date}</li>
                    <li class="list-group-item"><strong>Description:</strong> ${eventoDetails.description}</li>
                    <li class="list-group-item"><strong>Category:</strong> ${eventoDetails.category}</li>
                    <li class="list-group-item"><strong>Place:</strong> ${eventoDetails.place}</li>
                    <li class="list-group-item"><strong>Capacity:</strong> ${eventoDetails.capacity}</li>
                    <li class="list-group-item"><strong>Assistance:</strong> ${eventoDetails.assistance}</li>
                    <li class="list-group-item"><strong>Price:</strong> ${eventoDetails.price}</li>
                </ul>
            </div>
